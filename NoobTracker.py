...
print(Fore.GREEN+str(os.popen("date").read()))
...
try:
	while True:
		...
		if choix.lower() == 'h':
				...
				if choix.lower() == 'h':
					...
					while True:
						...
						if choixPr.upper() == 'N':
							...
							break
					while True:
						print(question+" Want to register an facebook account to profile ?")
						choixPr = input(" [O/n]: " )
						if choixPr.upper() == 'N':
							break
						else:
			...
			print(lookupOption)
			while True:
				lookup = input("\n NoobTracker("+Fore.BLUE+"Lookup"+Fore.BLUE + "" + Fore.RESET + ")$ ")
				if lookup == 'h':
					print(helpLookup)
				elif lookup.lower() == '1':
			...
			while True:
				se = input("\n NoobTracker("+Fore.BLUE+"OtherTool"+Fore.BLUE + "" + Fore.RESET + ")$ ")
				if se == 'h':
					print(helpOtherTool)
				elif se == "1":
					hashdecrypt()
